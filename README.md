...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-riingo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9204&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-riingo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-riingo` can be installed with:

```
conda install r-riingo
```

It is possible to list all of the versions of `r-riingo` available on your platform with:
